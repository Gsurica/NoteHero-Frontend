...
export const About = () => {
  return (
    <Layout phrase='About me...'>
      <div className="p-4 md:p-10 md:flex md:justify-around">
        <div className="flex items-center justify-center flex-col bg-slate-200 rounded-lg md:p-10">
          <h1>About me...</h1>
          <p>A little talk about the note hero's dev</p>
          <ArrowRight />
        </div>
        <div className="flex items-center justify-center flex-col bg-slate-200 rounded-lg mt-4 md:p-10">
